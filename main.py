...
flags.DEFINE_string('config_path', 'configs/pricing_diffrate_d100.json',
                    """The path to load json file.""")
flags.DEFINE_string('exp_name', 'pricing_diffrate_d100',
...
def main(argv):
    ...
    np.savetxt('logs/pricing_diffrate_d100_result{}.csv'.format(str(n_test[1])),
               training_history,
               fmt=['%d', '%.5e', '%.5e', '%d'],
               delimiter=",",
